                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-md table-striped" id="table">
                                        ...
                                        <tbody>
                                            <?php
                                            include_once("C:\wamp64\www\Projet_Web_TP-main\Mini\Metier\client.php");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span>
                                                            <a data-bs-toggle="modal" data-bs-target="#view<?= $t->get("n") ?>">
                                                                <svg class="bi" width="1em" height="1em" fill="currentColor">
                                                                    <use xlink:href="../../assets/images/bootstrap-icons.svg#eye">
                                                                    </use>
                                                                </svg>
                                                            </a>&#124;
                                                            <a data-bs-toggle="modal" data-bs-target="#supprimer<?= $t->get("n") ?>">
                                                                <svg class="bi" width="1em" height="1em" fill="currentColor">
                                                        ...
                                                        <div class="modal fade bd-example-modal-lg" id="view<?= $t->get("n") ?>" tabindex="0" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body" id="<?= $t->get("n") ?>">
                                                                        <div class="table-responsive">
                                                                            <table class="table table-md " id="table">
                                                                                ...
                                                                                <tbody>
                                                                                    <?php
                                                                                    include_once("C:\wamp64\www\Projet_Web_TP-main\Mini\Metier\ligneCmd.php");
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <button type="button" class="btn btn-danger" onclick="print(<?= $t->get('n') ?>)">Print</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!-- ---------------------------Supprimer --------------------------- -->
                                                        <div class="modal fade bd-example-modal-sm" id="supprimer<?= $t->get("n") ?>" tabindex="0" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-centered modal-sm">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                                        <a href='supprimerCommande.php?id=<?= $t->get("n") ?>'>
